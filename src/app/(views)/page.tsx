                    ...
                    <CCard className="mb-4">
                        ...
                        <CCardBody>
                            <CRow>
                                <CCol xs={12} md={6} xl={6}>
                                    <CRow>
                                        <CCol sm={6}>
                                            <div
                                                className="border-start border-start-4 border-start-info py-1 px-3 mb-3">
                                                <div className="text-body-secondary text-truncate small">New Clients
                                                </div>
                          ...
                          {item.value}{' '}
                            ...
                            <CTable align="middle" className="mb-0 mt-3 border" hover responsive>
                                ...
                                <CTableBody>
                                    {tableExample.map((item, index) => (
                                        <CTableRow v-for="item in tableItems" key={index}>
                                            ...
                                            <CTableDataCell>
                                                <div
                                                    className="d-flex justify-content-between align-items-baseline text-nowrap">
                                                    <div className="fw-semibold">{item.usage.value}%</div>
                                                    <div
                                                        className="text-body-secondary small ms-3">{item.usage.period}</div>
                                                </div>
                                                <CProgress
                                                    thin
